...
const RequestVisitList: React.FC = () => {
  ...
  const toDetail = () => {
    history.push("/visit/requestvisitemployee");
  };
  ...
  return (
    <IonPage>
      <IonContent fullscreen>
        ...
        <div onClick={toDetail} className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border">
            <div className="flex-auto p-4">
              <div className="flex flex-row -mx-3">
                ...
                <div className="px-3 w-96 text-center basis-2/3 rounded-lg bg-gradient-to-tl from-blue-400 to-blue-800">
                    <p  className="align-middle mt-2 font-bold text-white leading-normal text-sm">Requested</p>
                </div>
              </div>
            </div>
          </div>

          <div onClick={toDetail} className="relative flex flex-col min-w-0 break-words bg-white shadow-soft-xl rounded-2xl bg-clip-border mt-2">
            <div className="flex-auto p-4">
              <div className="flex flex-row -mx-3">
                <div className="flex-none w-2/3 max-w-full px-3">
                  <div>
...
export default RequestVisitList;
