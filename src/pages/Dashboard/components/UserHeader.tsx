...
const UserHeader: React.FC<UserHeaderProps> = ({ pegawai }) => {
    ...
    return (
        <>
            <div className="relative">
                ...
                <span className="absolute bg-green-500 rounded-md text-white text-xs px-2 -mt-3">Masuk</span>
            </div>
            <div className="flex-1 truncate">
                ...
                <div className="flex justify-between space-x-3">
                    <button className="inline-flex mt-1 text-center justify-between rounded-md bg-gray-900 bg-opacity-30 px-2.5 py-1">
                        ...
                        <span className="text-white text-xs">123 Points</span>
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
