...
const FormRequestTempUnit: React.FC = () => {
        ...
        <IonPage>
            <IonContent fullscreen>
                ...
                <div className="bg-white flex flex-col min-h-screen justify-between">
                    ...
                    <div>
                        {/* === Start Header === */}
                        <ListHeader title={"Form Permintaan Unit Sementara"} isReplace={false} link={""} addButton={false} />
                        {/* === End Header ===*/}
...
export default FormRequestTempUnit;
