...
import {
    ...
    FUEL_REQ_GA_LIST_URI, FUEL_REQ_FINANCE_LIST_URI
} from "../../../../constant/Index";
...
const GARequestFuelList: React.FC = () => {
    ...
    const btnDetailReqFuel = (id: any) => {
        if (role == 'GA') {
            history.push({
                pathname: "/fuel/req-fuel/ga-approval/" + id,
                state: { detail: id }
              });
        } else {
            history.push({
                pathname: "/fuel/req-fuel/finance-approval/" + id,
                state: { detail: id }
              });
        }
        ...
        <IonPage>
            <IonContent fullscreen>
                ...
                <div className="bg-red-700 ">
                    {/* Header */}
                    <ListHeader title={"Daftar Permintaan Bahan Bakar"} isReplace={false} link={""} addButton={false} />
                    {/* end Header */}
...
export default GARequestFuelList;
